    ...
    <>
        ...
        <nav>
          ...
          <div className="nav-links" id="navLinks">
            <ul>
              ...
              <li><a href="#images" className="smooth-scroll">IMAGES</a></li>
              <li><a href="#videos" className="smooth-scroll">VIDEOS</a></li>
            </ul>
          </div>
      ...
      <div className="menu" id="menu">
        <ul className="menu-link">
          <li><a href="../index.html">HOME</a></li>
          <li><a className="close" href="#about">ABOUT</a></li>
          <li><a className="close" href="#images">IMAGES</a></li>
          <li><a className="close" href="#videos">VIDEOS</a></li>
        </ul>
      </div>

      <div className="center">
        <h1 id="title">Welcome to Our <br /><span className="heading-span">Child Therapy</span></h1>
      ...
      <section id="about" className="about">
        ...
        <div className="bfit">
          <img src="../images/about-child.jpg" width="700" height="600" alt="about-child" />
          <div className="btext">
      ...
      <section id="images">
        ...
        <div className="main-scroll-div">
          <div>
            <button className="icon" ><i className="fas fa-angle-double-left"></i></button>
          </div>
          <div className="cover">
            <div className="scroll-images">
              <div className="child"><img className="child-img" src="../images/slider-8.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-3.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-4.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-5.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-6.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-2.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-7.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-8.jpg" alt="image" /></div>
              <div className="child"><img className="child-img" src="../images/slider-9.jpg" alt="image" /></div>
            </div>
          </div>
          <div>
            <button className="icon" ><i className="fas fa-angle-double-right"></i></button>
          </div>
        </div>
        <br />
      </section>
